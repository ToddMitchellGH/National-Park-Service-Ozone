def anomalies( fdat, yr1=None, yr1clim=None, yr2clim=None, nperyr=None ):
    ...
    Inputs
        ...
        nperyr (optional, default = 12 )
    Outputs  anom, clim
        anom    anomaly dataset
        clim      climatology

    This is the python version of my Matlab script.  Key python code by Jeremy McGibbon
...
# *** start here *** 
    for icnt in np.arange( nperyr ):
        ...
        anom[ skip+icnt:skip+nt2:nperyr ] = fdat[ skip+icnt:skip+nt2:nperyr ] - ( clim[icnt] )[None]
...
Input:
    xvals   tuple of first and last xtick values, and increment
    ...
    for icnt, xval in enumerate( np.arange( xvals[0], xvals[1]+xvals[2], xvals[2] ) ):
        plt.plot( ( xval, xval ), ( yvals[0], yvals[1] ), color=color )
